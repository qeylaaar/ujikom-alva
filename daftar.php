...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Silahkan Daftar Terlebih dahulu jika tidak memiliki akun</p>
      ...
      <form action="assets/index3.html" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <a href="index.php"><button type="submit" class="btn btn-primary btn-block">Daftar</button></a>
          </div>
          <!-- /.col -->
        </div>
      </form>
