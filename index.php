        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <h6 class="card-title">Welcome to Adukan!</h6>

                <p class="card-text">Di aplikasi ini, kalian bisa menulis aduan kalian lho, aduan kalian akan menjadi motivasi dan evaluasi bagi kami!, silahkan klik tombol dibawah untuk mulai mengetik aduan kalian</p>
